...
export const messages = {
    de: {
        ...
        flightLegs: {
            ...
            outbound: "Hinflug",
            return: "Rückflug",
            addOutbound: "Hinflug-Abschnitt hinzufügen",
            addReturn: "Rückflug-Abschnitt hinzufügen",
            carrier: "Airline",
            flightNumber: "Flugnummer",
            depAirport: "Abflughafen (IATA)",
            depTime: "Abflugzeit",
            arrAirport: "Zielflughafen (IATA)",
            arrTime: "Ankunftszeit",
            remove: "Entfernen",
            segment: "Abschnitt",
            noLegs: "Keine Flugreisen hinterlegt",
            showFlightMap: "Flugroute auf öffentlicher Seite anzeigen",
            showFlightMapHint: "Finder können deine Route auf einer Karte sehen",
            flightRouteTitle: "Flugroute",
            errorArrivalBeforeDeparture: "Ankunft darf nicht vor dem Abflug liegen",
            errorDepartureBeforePrevArrival: "Abflug darf nicht vor der Ankunft des vorherigen Abschnitts liegen",
        },
        impressum: {
            title: "Impressum",
    ...
    en: {
        ...
        flightLegs: {
            ...
            outbound: "Outbound",
            return: "Return",
            addOutbound: "Add outbound segment",
            addReturn: "Add return segment",
            carrier: "Airline",
            flightNumber: "Flight number",
            depAirport: "Departure airport (IATA)",
            depTime: "Departure time",
            arrAirport: "Arrival airport (IATA)",
            arrTime: "Arrival time",
            remove: "Remove",
            segment: "Segment",
            noLegs: "No flights added",
            showFlightMap: "Show flight route on public page",
            showFlightMapHint: "Finders can see your route on a map",
            flightRouteTitle: "Flight Route",
            errorArrivalBeforeDeparture: "Arrival cannot be before departure",
            errorDepartureBeforePrevArrival: "Departure cannot be before the previous segment's arrival",
        },
        impressum: {
            title: "Legal Notice",
            companyName: "Kreativschicht.de",
    ...
    nl: {
        ...
        dashboard: {
            ...
            view: "Bekijken",
            edit: "Bewerken",
            scanHint: "Scan een NFC-tag om deze aan je account toe te voegen.",
            pleaseLogin: "Log in om je tags te bekijken.",
        ...
        flightLegs: {
            ...
            outbound: "Heenvlucht",
            return: "Terugvlucht",
            addOutbound: "Heenvlucht segment toevoegen",
            addReturn: "Terugvlucht segment toevoegen",
            carrier: "Luchtvaartmaatschappij",
            flightNumber: "Vluchtnummer",
            depAirport: "Vertrekhaven (IATA)",
            depTime: "Vertrektijd",
            arrAirport: "Aankomsthaven (IATA)",
            arrTime: "Aankomsttijd",
            remove: "Verwijderen",
            segment: "Segment",
            noLegs: "Geen vluchten toegevoegd",
            showFlightMap: "Vliegroute weergeven op openbare pagina",
            showFlightMapHint: "Vinders kunnen je route op een kaart zien",
            flightRouteTitle: "Vliegroute",
            errorArrivalBeforeDeparture: "Aankomst mag niet vóór vertrek zijn",
            errorDepartureBeforePrevArrival: "Vertrek mag niet vóór de aankomst van het vorige segment zijn",
        },
        impressum: {
            title: "Impressum",
            companyName: "Kreativschicht.de",
    ...
    ko: {
        ...
        dashboard: {
            ...
            view: "보기",
            edit: "편집",
            scanHint: "NFC 태그를 스캔하여 계정에 추가하세요.",
            pleaseLogin: "태그를 보려면 로그인하세요.",
            tagManagement: "태그 관리",
            tagDetails: "태그 세부정보",
        ...
        flightLegs: {
            ...
            outbound: "출발편",
            return: "귀국편",
            addOutbound: "출발 구간 추가",
            addReturn: "귀국 구간 추가",
            carrier: "항공사",
            flightNumber: "편명",
            depAirport: "출발 공항 (IATA)",
            depTime: "출발 시간",
            arrAirport: "도착 공항 (IATA)",
            arrTime: "도착 시간",
            remove: "제거",
            segment: "구간",
            noLegs: "항공편 없음",
            showFlightMap: "공개 페이지에 비행 경로 표시",
            showFlightMapHint: "발견자가 지도에서 경로를 볼 수 있습니다",
            flightRouteTitle: "비행 경로",
            errorArrivalBeforeDeparture: "도착 시간은 출발 시간 이후여야 합니다",
            errorDepartureBeforePrevArrival: "출발 시간은 이전 구간 도착 시간 이후여야 합니다",
        },
        impressum: {
            title: "법적 고지",
            companyName: "Kreativschicht.de",
    ...
    ar: {
        ...
        dashboard: {
            ...
            view: "عرض",
            edit: "تحرير",
            scanHint: "امسح علامة NFC لإضافتها إلى حسابك.",
            pleaseLogin: "يرجى تسجيل الدخول لعرض علاماتك.",
            ...
            noOwnerName: "لا يوجد اسم المالك",
        ...
        flightLegs: {
            ...
            return: "رحلة العودة",
            addOutbound: "إضافة قطاع ذهاب",
            addReturn: "إضافة قطاع عودة",
            carrier: "شركة الطيران",
            flightNumber: "رقم الرحلة",
            depAirport: "مطار المغادرة (IATA)",
            depTime: "وقت المغادرة",
            arrAirport: "مطار الوصول (IATA)",
            arrTime: "وقت الوصول",
            remove: "إزالة",
            segment: "قطاع",
            noLegs: "لا توجد رحلات جوية",
            showFlightMap: "عرض مسار الرحلة على الصفحة العامة",
            showFlightMapHint: "يمكن للمكتشفين رؤية مسارك على الخريطة",
            flightRouteTitle: "مسار الرحلة",
            errorArrivalBeforeDeparture: "لا يمكن أن يكون وقت الوصول قبل وقت المغادرة",
            errorDepartureBeforePrevArrival: "لا يمكن أن يكون وقت المغادرة قبل وصول المقطع السابق",
        },
        impressum: {
            title: "إشعار قانوني",
            companyName: "Kreativschicht.de",
    ...
    th: {
        ...
        dashboard: {
            ...
            view: "ดู",
            edit: "แก้ไข",
            scanHint: "สแกนแท็ก NFC เพื่อเพิ่มลงในบัญชีของคุณ",
            pleaseLogin: "กรุณาเข้าสู่ระบบเพื่อดูแท็กของคุณ",
            scanTag: "สแกนแท็ก",
        ...
        flightLegs: {
            ...
            return: "เที่ยวบินขากลับ",
            addOutbound: "เพิ่มเที่ยวบินขาไป",
            addReturn: "เพิ่มเที่ยวบินขากลับ",
            carrier: "สายการบิน",
            flightNumber: "หมายเลขเที่ยวบิน",
            depAirport: "สนามบินต้นทาง (IATA)",
            depTime: "เวลาออกเดินทาง",
            arrAirport: "สนามบินปลายทาง (IATA)",
            arrTime: "เวลาถึง",
            remove: "ลบ",
            segment: "ส่วน",
            noLegs: "ไม่มีเที่ยวบิน",
            showFlightMap: "แสดงเส้นทางบินในหน้าสาธารณะ",
            showFlightMapHint: "ผู้พบเห็นสามารถดูเส้นทางของคุณบนแผนที่ได้",
            flightRouteTitle: "เส้นทางบิน",
            errorArrivalBeforeDeparture: "เวลาถึงต้องไม่อยู่ก่อนเวลาออกเดินทาง",
            errorDepartureBeforePrevArrival: "เวลาออกเดินทางต้องไม่อยู่ก่อนเวลาถึงของเที่ยวบินก่อนหน้า",
        },
        impressum: {
